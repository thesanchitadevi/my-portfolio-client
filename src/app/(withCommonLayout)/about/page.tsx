...
const AboutPage = () => {
  return (
    <section className="py-24 xl:mr-0 lg:mr-5 mr-0">
          ...
          <div className="w-[80%] flex flex-col justify-center gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 font-semibold pt-5">
                I am passionate Junior Designer, and I&apos;m very dedicated to
                my work. With 1 year of experience as a professional Web
